...
var nombre = 'Edwin Lonazco Ayala';    
var fecha = '';   
function ExampleOne() {  
    return (
        <React.Fragment>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 col-sm-8 col-md-6 col-xl-4 " >
                                        ...
                                        <select className="form-select mb-2" name="tax" data-control="select2" data-hide-search="false" data-placeholder="Seleccione un cliente">
                                            <option></option>
                                            <option value="0">0838485 - Rogel gamarra</option>
                                            <option >0838332 - Taxable Goods</option>
                                            <option value="2">0578485 - Downloadable Product</option>
                                            <option value="s">0838485 - Arnaldo</option>
                                        </select>
                                    </div>
                                    <div className="col-12 col-sm-8 col-md-6 col-xl-4 " >
                            ...
                            <div className="row" >
                                <div data-edwin className="col-12" >
                                    ...
                                    <ul className="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-n2">
                                        ...
                                        <li className="nav-item">
                                            <a className="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_ecommerce_add_solicitud_general">Productos</a>
                                        </li>
                                        <li className="nav-item">
...
if (document.getElementById('example')) {
    ReactDOM.render(<ExampleOne />, document.getElementById('example'));
}
